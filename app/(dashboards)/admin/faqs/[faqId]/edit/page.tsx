...
export default function EditFAQPage() {
  ...
  const handleSave = async () => {
    ...
    // Parse orderIndex, default to current if empty
    const orderIndex = formData.orderIndex ? parseInt(formData.orderIndex, 10) : undefined;
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1">Update the FAQ information below</p>
            </div>
          </div>
        </div>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              <Input
                ...
                className="h-12 border-2 border-slate-300 bg-white focus:border-[color:var(--brand-blue)] focus:ring-2 focus:ring-[color:var(--brand-blue)]/20 transition-all shadow-sm"
              />
              <p className="text-xs text-slate-500 font-medium">Controls the display order. Lower numbers appear first.</p>
            </div>
