...
const enrollmentData = {
  ...
  course: {
    ...
    description: "Master concise messaging, confident delivery and persuasive storytelling for boardroom-ready communication.",
    level: "intermediate",
    price: 125,
    duration: 30, // days
...
const courseMaterials = [
  {
    materialId: "mat-1",
    title: "Kickoff: Communication Mindsets",
    type: "video",
    url: "#",
    orderIndex: 1,
    completed: true,
  ...
  {
    materialId: "mat-2",
    title: "Message Blueprint Canvas",
    type: "video",
    url: "#",
    orderIndex: 2,
    completed: true,
  ...
  },
  {
    ...
    type: "link",
    url: "https://example.com/executive-presence-checklist",
    orderIndex: 6,
    completed: false,
    duration: null,
  },
...
const quizzes = [
  {
    ...
    description: "Test concise messaging, tone and clarity techniques.",
    status: "completed",
    score: 95,
    questions: 10,
  ...
  },
  {
    ...
    description: "Apply story arcs to different stakeholders and time slots.",
    status: "completed",
    score: 88,
    questions: 8,
  ...
  {
    quizId: "quiz-3",
    title: "Executive Presence Simulation",
    description: "Practice responding to high-pressure questions.",
    status: "pending",
    score: null,
    questions: 12,
    completedAt: null,
